...
class PUE extends Service_Provider {
	 ...
	 * @var string
	 */
	private static $pue_slug = 'extension-exclude-qr-code-from-selected-tickets';
	...
	public function register() {
		...
		$this->container->singleton( 'extension.exclude_qr_code_from_selected_tickets.pue', $this );
